...
import { BellIcon, HomeIcon, UsersIcon, SettingsIcon } from "lucide-react";
    ...
    <aside className="w-64 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
      <div className="p-5 border-b border-base-300">
        <Link to="/" className="flex items-center gap-2.5">
          <WaveLogo className="size-9 text-primary" />
        ...
        <Link to="/profile" className="flex items-center gap-3 hover:bg-base-300 p-2 rounded-lg transition-colors">
          <div className="avatar">
            <div className="w-10 rounded-full">
              <img 
                src={authUser?.profilePic || "https://via.placeholder.com/150?text=User"} 
                alt="User Avatar" 
                onError={(e) => {
